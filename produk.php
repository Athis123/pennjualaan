...
if (isset($_POST['tambah'])) {
    ...
    $koneksi->query("INSERT INTO produk (nama, kode, harga, stok) VALUES ('$nama', '$kode', '$harga', '$stok')");
...
if (isset($_POST['update'])) {
    ...
    $nama = mysqli_real_escape_string($koneksi, $_POST['nama']);
    $kode = mysqli_real_escape_string($koneksi, $_POST['kode']);
    $harga = mysqli_real_escape_string($koneksi, $_POST['harga']); // Perbaikan di sini
    $stok = mysqli_real_escape_string($koneksi, $_POST['stok']);
    $koneksi->query("UPDATE produk SET nama='$nama', kode='$kode', harga='$harga', stok='$stok' WHERE id=$id");
    header("Location: produk.php");
    exit;
}
                ...
                <div class="container-fluid py-4">
                    ...
                    <form method="post" class="mb-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col">
                                <input type="number" name="harga" class="form-control" placeholder="harga" value="<?= $edit['harga'] ?? '' ?>" required>
                            </div>
                            <div class="col">
                                <input type="text" name="stok" class="form-control" placeholder="stok" value="<?= $edit['stok'] ?? '' ?>" required>
                            </div>
                            <div class="col">
