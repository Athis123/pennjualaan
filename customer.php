...
if (isset($_POST['tambah'])) {
    ...
    $alamat = $_POST['alamat'];
    $koneksi->query("INSERT INTO customer (nama, telepon, alamat) VALUES ('$nama', '$telepon', '$alamat')");
...
if (isset($_POST['update'])) {
    ...
    $telepon = $_POST['telepon'];
    $alamat = $_POST['alamat'];
    $koneksi->query("UPDATE customer SET nama='$nama', telepon='$telepon', alamat='$alamat' WHERE id=$id");
    header("Location: customer.php");
    exit;
}
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $result = $koneksi->query("SELECT * FROM customer WHERE id=$id");
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="customer.php" id="m_customer">Customer</a>
                        <a class="collapse-item" href="produk.php" id="m_produk">Produk</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="container-fluid py-4">
                    ...
                    <form method="post" class="mb-3">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col">
                                <input type="text" name="telepon" class="form-control" placeholder="Telepon" value="<?= $edit['telepon'] ?? '' ?>" required>
                            </div>
                            <div class="col">
